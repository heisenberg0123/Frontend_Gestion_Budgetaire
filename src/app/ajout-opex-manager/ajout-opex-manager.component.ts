...
@Component({
  selector: 'app-ajout-opex-manager',
  templateUrl: './ajout-opex-manager.component.html',
  styleUrls: ['./ajout-opex-manager.component.css']
})
export class AjoutOpexManagerComponent {
